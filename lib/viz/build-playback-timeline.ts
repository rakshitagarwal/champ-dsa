...
import type { VizScene, VizStructure, PointerBinding, SceneHighlight } from "@/types/viz-scene";
...
function traceStepToScene(step: TraceStep, stepIndex: number): VizScene {
