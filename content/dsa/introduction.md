...
**Start with the [Data Structures](/patterns/data-structures) theory hub** — 9 cards (what, structure, big-O, catch, keywords) — then the [Algorithms](/patterns/algorithms) hub (22 patterns) — then work the revision list below.
