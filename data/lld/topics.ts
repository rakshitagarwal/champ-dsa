...
export const LLD_GROUPS: LldGroup[] = [
  ...
  { id: "patterns", title: "C. Design Patterns" },
...
const GROUP_OF: Record<string, LldTopicWithNum["group"]> = {
  ...
  "prototype-pattern": "patterns",
  "adapter-pattern": "patterns",
  "decorator-pattern": "patterns",
  "facade-pattern": "patterns",
  "proxy-pattern": "patterns",
  "composite-pattern-file-system": "patterns",
  "strategy-pattern": "patterns",
  "observer-pattern": "patterns",
  "chain-of-responsibility": "patterns",
  "command-undo-redo": "patterns",
  "state-pattern": "patterns",
  "template-method-pattern": "patterns",
  "iterator-pattern": "patterns",
  "mediator-auction-system": "patterns",
  "uml-diagrams": "design",
